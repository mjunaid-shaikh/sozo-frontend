...
import {starPolygonPoints} from "../helper-function/general-helper"
...
export const createStars = (
  ...
  let points = starPolygonPoints(5, 100, 50);
  ...
  let centerPos = star.getCenterPoint();
  ...
  helperData.scope.canvas.add(star, text);
  ...
  shapesEventManager(star, text, mainToolbarDiv,helperData);
  text.enterEditing();
  emitObjectAdded([star, text],helperData);
  // updateCanvasState();
}

export const reCreateStar = (data, actualServer = false,helperData) => {
